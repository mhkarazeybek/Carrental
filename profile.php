...
<title>Araba Kiralama | Profilim</title>
<!--Bootstrap -->
    ...
    <div class="row">
      ...
      <div class="col-md-6 col-sm-8">
        <div class="profile_wrap">
          ...
          <?php  
         if($msg){?><div class="succWrap"><strong>BAŞARILI</strong>:<?php echo htmlentities($msg); ?> </div><?php }?>
          <form  method="post">
           <div class="form-group">
            ...
            <?php } ?>
            <div class="form-group">
              <label class="control-label">Tüm Ad</label>
            ...
            <div class="form-group">
              <label class="control-label">Doğum Tarihi&nbsp;(dd/mm/yyyy)</label>
