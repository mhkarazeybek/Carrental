...
<title>Araba Kiralama |Bonservis Yayınla</title>
<!--Bootstrap -->
  ...
  <div class="container">
    <div class="page-header_wrap">
      <div class="page-heading">
        <h1>Bonservis Yayınla</h1>
      </div>
      <ul class="coustom-breadcrumb">
        <li><a href="#">Ana Sayfa</a></li>
        <li>Bonservis Yayınla</li>
      </ul>
    </div>
  </div>
  <!-- Dark Overlay-->
    ...
    <div class="row">
      ...
      <div class="col-md-6 col-sm-8">
        <div class="profile_wrap">
          <h5 class="uppercase underline">Bonservis Yayınla</h5>
          ...
          <form  method="post">
            ...
            <div class="form-group">
              <label class="control-label">Bonservis</label>
